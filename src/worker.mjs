...
const PASSWORD_TYPES = [
  {
    ...
    description: "An 8-digit password derived from a birth date in DDMMYYYY format (e.g. 15081990 for 15 Aug 1990). Very common choice because it is easy to remember. Only plausible calendar dates are valid: days 01–31, months 01–12, years roughly 1920–2009.",
    format: "DDMMYYYY",
    charSpace: "digits 0-9, constrained to plausible calendar dates",
    charSpaceSize: 10,
    length: 8,
    regex: "^(0[1-9]|[12][0-9]|3[01])(0[1-9]|1[0-2])(19[2-9][0-9]|200[0-9])$",
    regexExplained: "DD = 01-31, MM = 01-12, YYYY = 1920-2009",
    possibleValues: 26645,
    possibleValuesNote: "Approx. 365.25 days × 73 years (1920–2009), reduced for invalid day/month combos. Far smaller than a full 8-digit space.",
    exampleValues: ["01011990", "24121985", "07031975", "15082003"],
    crackingHint: "Brute-forceable in milliseconds — the year range and calendar constraints reduce the space to ~27k values.",
